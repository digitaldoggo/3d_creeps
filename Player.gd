...
var animation_speed_scale_moving = 4
var animation_speed_scale_idle = 1
...
func _physics_process(delta: float) -> void:
	...
	if direction != Vector3.ZERO:
		...
		$AnimationPlayer.speed_scale = animation_speed_scale_moving
	else:
		$AnimationPlayer.speed_scale = animation_speed_scale_idle
